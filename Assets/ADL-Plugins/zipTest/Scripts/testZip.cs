...
public class testZip : MonoBehaviour
{
    ...
    IEnumerator DownloadZipFile()
    {
		...
		UnityWebRequest request = new UnityWebRequest("https://dl.dropboxusercontent.com/s/xve34ldz3pqvmh1/" + myFile);
		...
		File.WriteAllBytes(ppath + "/" + myFile, request.downloadHandler.data);
