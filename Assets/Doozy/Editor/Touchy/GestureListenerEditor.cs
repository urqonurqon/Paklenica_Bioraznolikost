...
namespace Doozy.Editor.Touchy
{
    ...
    public class GestureListenerEditor : BaseEditor
    {
        ...
        private void DrawIsGlobalListener()
        {
            ...
            GetInfoMessage(EVERY_SWIPE_WILL_TRIGGER_THIS_LISTENER).DrawMessageOnly(m_globalListenerProperty.boolValue && Target.GestureType == GestureType.Swipe && Target.SwipeDirection != (Engine.Touchy.Swipe) Swipe.None);
        }
        ...
        {
            bool hasValidSwipeDirection = Target.SwipeDirection != (Engine.Touchy.Swipe) Swipe.None;
            ...
            GUILayout.EndHorizontal();
            GetInfoMessage(SELECT_SWIPE_DIRECTION).DrawMessageOnly(Target.GestureType == GestureType.Swipe && Target.SwipeDirection == (Engine.Touchy.Swipe) Swipe.None);
        }
