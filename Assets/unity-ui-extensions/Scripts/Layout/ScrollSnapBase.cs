...
namespace UnityEngine.UI.Extensions
{
    public class ScrollSnapBase : MonoBehaviour, IBeginDragHandler, IDragHandler, IScrollSnap
    {
        ...
        /// <returns>Closest Screen number (zero indexed array value)</returns>
        ...
        /// </summary>
        /// <param name="page">Screen that the position is required for (Zero indexed array value)</param>
        ...
        /// </summary>
        /// <returns>Currently selected Screen Transform</returns>
        ...
        /// </summary>
        /// <param name="returnObject">Currently selected Screen Transform</param>
